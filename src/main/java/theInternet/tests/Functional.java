...
public class Functional extends TestSuperClass{
	...
	// As a User
	// I want to download and read .txt file
	// So I know I downloaded the correct file
//	@Test
	...
	// So I know I downloaded the correct file
//	@Test
	public void scrollAndGetParagraph() throws Exception {
		String paragraph = new InfiniteScrollPage(driver, baseUrl)
				.navigate()
				.getNumberOfParagraphShown()
				.scrollToGetNextParagraph()
				.getParagraph();

		Assert.assertTrue(!paragraph.isEmpty(), "Scroll Test Failed");
	}
	...
	public void openTabGetHeaderAndCloseTab() {
		...
		String actualHeaderText = new WindowPage(driver, baseUrl)
				.navigate()
				.clickLinkToNewTab()
				.getTextAndClose();
